...
from tns_api.models import Location
...
class Command(BaseCommand):
    help = "Seed Zimbabwe cities and towns into the Location table"
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(
            self.style.SUCCESS(
                f"Location seeding complete. created={created}, updated={updated}, total={len(LOCATIONS)}"
            )
        )
